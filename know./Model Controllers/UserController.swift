...
class UserController {
    ...
    func saveUser(withName name: String, menstruates: Bool, cycles: [Cycle]? = [], age: Int?, birthdate: Date?, height: Int?, weight: Int?, cycleLength: [Int]?, periodLength: Int?, pms: Bool?, pmsDuration: Int?, lastPeriod: Date?, completion: @escaping(Bool) -> Void) {
        let user = User(cycles: cycles!, menstruates: menstruates, name: name, age: age, birthdate: birthdate, height: height, weight: weight, cycleLength: cycleLength, periodLength: periodLength, pms: pms, pmsDuration: pmsDuration, lastPeriod: lastPeriod)
    ...
    func update(user: User, withName name: String?, menstruates: Bool, cycles: [Cycle]?, birthdate: Date?, age: Int?, height: Int?, weight: Int?, cycleLength: [Int]?, periodLength: Int?, pms: Bool?, pmsDuration: Int?, lastPeriod: Date?, authEnabled: Bool?, updateNotificationEnabled: Bool?, lateNotificationEnabled: Bool, completion: @escaping(Bool) -> Void) {
        user.name = name
        user.menstruates = menstruates
        user.cycles = cycles!
